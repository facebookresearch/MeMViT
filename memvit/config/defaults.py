...
# If True, optimizer states are not loaded.
_C.TRAIN.CHECKPOINT_NO_LOAD_OPT = False
...
_C.TEST.FULLY_CONV_TEST = False

_C.TEST.SAVE_KINETICS_PREDS = False
...
_C.DATA.PERTURB_AVA_FRAMES = False
...
_C.DATA_LOADER.TEST_NUM_WORKERS = -1
...
_C.AVA.TRAIN_USE_COLOR_AUGMENTATION = True

# Whether to only use PCA jitter augmentation when using color augmentation
# method (otherwise combine with color jitter method).
_C.AVA.TRAIN_PCA_JITTER_ONLY = False
